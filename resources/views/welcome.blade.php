...
<html>
    ...
    <style>
         ...
         header {
            ...
            padding-top: 40px;
            min-height: 70px;
            border-bottom: #050100 3px solid;}
        header ul {
            padding: 0;
            list-style: none;
        }
    ...
    <body>
        <header>
            <div class="container">
                ...
                <h1 > <span style="color: #e8491d;" >Laravel</span> Website</h1>
        ...
        @csrf <!-- Include CSRF token -->
            ...
            <input type="email" id="emaail" name="email" placeholder="enter email" required><br><br>
